...
exec_interface.o: $(src_dir)/exec_interface.cc
	g++ -c -O2 $(src_dir)/exec_interface.cc -o $(obj_dir)/exec_interface.o

flux_func.o: $(src_dir)/flux_func.cc
	g++ -c -O2 $(src_dir)/flux_func.cc -o $(obj_dir)/flux_func.o

slic_2d_euler_solver.o: $(src_dir)/slic_2d_euler_solver.cc
	g++ -c -O2 $(src_dir)/slic_2d_euler_solver.cc -o $(obj_dir)/slic_2d_euler_solver.o

vec_transform.o: $(src_dir)/vec_transform.cc
	g++ -c -O2 $(src_dir)/vec_transform.cc -o $(obj_dir)/vec_transform.o
