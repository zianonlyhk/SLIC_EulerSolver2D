...
std::array<double, 4> FluxFVM::slicFlux_x(std::array<double, 4> i_uVector_0, std::array<double, 4> i_uVector_1, std::array<double, 4> i_uVector_2, std::array<double, 4> i_uVector_3, double i_dx, double i_dt)
{
    ...
    // get some vectors prepared in advanced
    ...
    // std::array<double, 4> delta_1 = sumCell(scalingCell(0.5 * (1 + local_omega), diffCell(i_uVector_1, i_uVector_0)), scalingCell(0.5 * (1 - local_omega), diffCell(i_uVector_2, i_uVector_1)));
    // uVec_1 = diffCell(i_uVector_1, scalingCell(0.5, delta_1));
